...
//STRUCTURED OUTPUT - PROMISING - even works on deepseek

//SYSTEM=""
//USER="

/*
Please translate the given input and context from en-US to de-DE in the following JSON format:
...
For example, if the input is "Hello" and the translation is "Hola" with 90% confidence, the output should look like:
...
Context: Cameras and photography
Input: "Loading... please dance for the data..."
*/

//returns
//{ "Translation": "Laden... bitte tanzen für die Daten", "Confidence": "90%"}
